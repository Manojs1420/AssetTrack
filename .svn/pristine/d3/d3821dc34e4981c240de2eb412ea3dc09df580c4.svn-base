...
import com.titan.irgs.fileupload.processor.AssetProcessor;
import com.titan.irgs.fileupload.repository.UploadDocumentRepository;

@RestController
@RequestMapping(value=WebConstantUrl.ASSET_FILE_BASE_URL)
public class AssetFileUploadController
{
	...
	private static Logger logger = LoggerFactory.getLogger( AssetFileUploadController.class);
      ...
      private UploadDocumentRepository uploadDocumentRepository;
               ...
               public ResponseEntity<Map<String,Object>>testApi(@RequestParam("file") Part part) throws Exception
               {
                               ...
                               List<String> result = null;
                                               ...
                                               document.setFileUploadType(FileUploadType.Asset);
                                               ...
                                               result = assetProcessor.importAssetRecords(inp);
