...
@Entity
@Table(name = "store_business_service_type")
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "storeBusinessServiceTypeId", scope = Long.class)
public class StoreBusinessServiceType {
