...
import com.titan.irgs.fileupload.processor.AssetPoProcessor;
import com.titan.irgs.fileupload.repository.UploadDocumentRepository;

@RestController
//@RequestMapping(value=WebConstantUrl.Asset_Po_file_Base_url)
public class AssetPoFileUploadController {
	
	
private static Logger logger = LoggerFactory.getLogger( InventoryAmcExtnFileUploadController.class);
    
    @Autowired
     private AssetPoProcessor  assetPoProcessor;
               ...
               @RequestMapping(value = WebConstantUrl.IMPORT_Asset_PO_FILE_UPLOAD ,method=RequestMethod.POST)
               public ResponseEntity<Map<String,Object>>testApi(@RequestParam("file") Part part) throws Exception
               {
                               ...
                               List<String> result = null;
                                               ...
                                               result = assetPoProcessor.importAssetPoRecords(inp);
