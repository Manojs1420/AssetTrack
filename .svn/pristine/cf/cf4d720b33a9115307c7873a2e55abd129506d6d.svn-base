...
import com.titan.irgs.fileupload.processor.EquipmentProcessor;
import com.titan.irgs.fileupload.repository.UploadDocumentRepository;



@RestController
@RequestMapping(value=WebConstantUrl.EQUIPMENT_FILE_BASE_URL)
public class EquipmentFileUploadController 
{
    ...
    private UploadDocumentRepository uploadDocumentRepository;
               ...
               @RequestMapping(value = WebConstantUrl.IMPORT_EQUIPMENT_FILE_UPLOAD ,method=RequestMethod.POST)
               public ResponseEntity<Map<String,Object>> testApi(@RequestParam("file") Part part) throws Exception
               {
                               ...
                               List<String> result = null;
                                               ...
                                               document.setName("Equipment = " + System.currentTimeMillis());
                                               document.setFileUploadType(FileUploadType.Equipment);
...
//                                                                           ExcelSheetProcessor.class);
                                               ...
                                               result = equipmentProcessor.importEquipmentRecords(inp);
