...
import com.titan.irgs.fileupload.processor.AssetVendorInvoiceRefProcessor;
import com.titan.irgs.fileupload.repository.UploadDocumentRepository;

@RestController
@RequestMapping(value=WebConstantUrl.Asset_Vendor_Invoice_ref_file_Base_url)
public class AssetVendorInvoiceReferenceFileUploadController {
	
	
private static Logger logger = LoggerFactory.getLogger( InventoryAmcExtnFileUploadController.class);
    
    @Autowired
     private AssetVendorInvoiceRefProcessor  assetVendorInvoiceRefProcessor;
               ...
               @RequestMapping(value = WebConstantUrl.IMPORT_Asset_VENDOR_INVOICE_FILE_UPLOAD ,method=RequestMethod.POST)
               public ResponseEntity<Map<String,Object>>testApi(@RequestParam("file") Part part) throws Exception
               {
                               ...
                               List<String> result = null;
                                               ...
                                               document.setName("InventoryAmc = " + System.currentTimeMillis());
                                               document.setFileUploadType(FileUploadType.InventoryAmcExtn);
                                               ...
                                               result = assetVendorInvoiceRefProcessor.importAssetVendorInvoiceRecords(inp);
