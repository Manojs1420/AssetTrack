...
import com.titan.irgs.fileupload.processor.ModelProcessor;
import com.titan.irgs.fileupload.repository.UploadDocumentRepository;

@RestController
@RequestMapping(value = WebConstantUrl.MODEL_FILE_BASE_URL)
public class ModelFileUploadController {

	
	
	
	private static Logger logger = LoggerFactory.getLogger( ModelFileUploadController.class);
    ...
    @Autowired
     private ModelProcessor  modelProcessor;
               ...
               @RequestMapping(value = WebConstantUrl.IMPORT_MODEL_FILE_UPLOAD ,method=RequestMethod.POST)
               public ResponseEntity<Map<String,Object>> testApi(@RequestParam("file") Part part) throws Exception
               {
                               ...
                               List<String> result = null;
                                               ...
                                               document.setName("Model = " + System.currentTimeMillis());
                                               document.setFileUploadType(FileUploadType.MODEL);
...
//                                                                           ExcelSheetProcessor.class);
                                               ...
                                               result = modelProcessor.importModelRecords(inp);
