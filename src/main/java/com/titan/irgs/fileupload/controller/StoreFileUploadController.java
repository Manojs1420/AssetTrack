...
import com.titan.irgs.fileupload.processor.StoreProcessor;
import com.titan.irgs.fileupload.repository.UploadDocumentRepository;


@RestController
@RequestMapping(value = WebConstantUrl.STORE_FILE_BASE_URL)
...
private static Logger logger = LoggerFactory.getLogger(StoreFileUploadController.class);
    ...
    @Autowired
     private StoreProcessor  storeProcessor;
               ...
               @RequestMapping(value = WebConstantUrl.IMPORT_STORE_FILE_UPLOAD ,method=RequestMethod.POST)
...
//                                                                           ExcelSheetProcessor.class);
                                               ...
                                               result = storeProcessor.importStoreRecords(inp);
