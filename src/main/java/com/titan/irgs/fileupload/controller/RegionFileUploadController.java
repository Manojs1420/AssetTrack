...
import com.titan.irgs.fileupload.processor.RegionProcessor;
import com.titan.irgs.fileupload.repository.UploadDocumentRepository;

@RestController
@RequestMapping(value = WebConstantUrl.REGION_FILE_BASE_URL)
public class RegionFileUploadController 
{


	private static Logger logger = LoggerFactory.getLogger(RegionFileUploadController.class);
    ...
    @Autowired
     private RegionProcessor  regionProcessor;
               ...
               @RequestMapping(value = WebConstantUrl.IMPORT_REGION_FILE_UPLOAD ,method=RequestMethod.POST)
               public ResponseEntity<Map<String,Object>> testApi(@RequestParam("file") Part part) throws Exception
               {
                               ...
                               List<String> result = null;
                                               ...
                                               document.setName("Region = " + System.currentTimeMillis());
                                               document.setFileUploadType(FileUploadType.REGION);
...
//                                                                           ExcelSheetProcessor.class);
                                               ...
                                               result = regionProcessor.importRegionRecords(inp);
