...
import com.titan.irgs.fileupload.processor.StateProcessor;
import com.titan.irgs.fileupload.repository.UploadDocumentRepository;

@RestController
@RequestMapping(value = WebConstantUrl.STATE_FILE_BASE_URL)
@CrossOrigin(origins = "*")
public class StateFileUploadController 
{
	

	private static Logger logger = LoggerFactory.getLogger(StateFileUploadController.class);
    ...
    @Autowired
     private StateProcessor  stateProcessor;
               ...
               @RequestMapping(value = WebConstantUrl.IMPORT_STATE_FILE_UPLOAD ,method=RequestMethod.POST)
               public ResponseEntity<Map<String,Object>> testApi(@RequestParam("file") Part part) throws Exception
               {
                               ...
                               List<String> result = null;
                                               ...
                                               document.setName("State = " + System.currentTimeMillis());
                                               document.setFileUploadType(FileUploadType.STATE);
...
//                                                                           ExcelSheetProcessor.class);
                                               ...
                                               result = stateProcessor.importStateRecords(inp);
