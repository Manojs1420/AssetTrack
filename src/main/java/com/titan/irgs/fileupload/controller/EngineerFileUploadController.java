...
import com.titan.irgs.fileupload.processor.EngineerProcessor;
import com.titan.irgs.fileupload.repository.UploadDocumentRepository;

@RestController
@RequestMapping(value=WebConstantUrl.ENGINEER_FILE_BASE_URL)
public class EngineerFileUploadController {
	
private static Logger logger = LoggerFactory.getLogger(EquipmentFileUploadController.class);
    
    @Autowired
     private EngineerProcessor  engineerProcessor;
    ...
    private UploadDocumentRepository uploadDocumentRepository;
               ...
               @RequestMapping(value = WebConstantUrl.IMPORT_ENGINEER_FILE_UPLOAD ,method=RequestMethod.POST)
               public ResponseEntity<Map<String,Object>> testApi(@RequestParam("file") Part part) throws Exception
               {
                               ...
                               List<String> result = null;
                                               ...
                                               document.setName("Engineer = " + System.currentTimeMillis());
                                               document.setFileUploadType(FileUploadType.Engineer);
                                               ...
                                               result = engineerProcessor.importEngineerRecords(inp);
