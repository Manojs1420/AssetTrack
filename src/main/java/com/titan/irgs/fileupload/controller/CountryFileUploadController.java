...
import com.titan.irgs.fileupload.processor.CountryProcessor;
import com.titan.irgs.fileupload.repository.UploadDocumentRepository;

@RestController
@RequestMapping(value = WebConstantUrl.COUNTRY_FILE_BASE_URL)
public class CountryFileUploadController
{
    
		private static Logger logger = LoggerFactory.getLogger(CountryFileUploadController.class);
      ...
      @RequestMapping(value = WebConstantUrl.IMPORT_COUNTRY_FILE_UPLOAD ,method=RequestMethod.POST)
      public ResponseEntity<Map<String,Object>> testApi(@RequestParam("file") Part part) throws Exception
      {
                      ...
                      List<String> result = null;
                                      ...
                                      document.setName("Country = " + System.currentTimeMillis());
                                      document.setFileUploadType(FileUploadType.COUNTRY);
...
//                                                                  ExcelSheetProcessor.class);
                                      ...
                                      result = countryProcessor.importCountryRecords(inp);
