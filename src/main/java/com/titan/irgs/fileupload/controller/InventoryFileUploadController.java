...
import com.titan.irgs.fileupload.processor.InventoryProcessor;
import com.titan.irgs.fileupload.repository.UploadDocumentRepository;

@RestController
@RequestMapping(value=WebConstantUrl.INVENTORY_FILE_BASE_URL)
public class InventoryFileUploadController {
	
	
private static Logger logger = LoggerFactory.getLogger( InventoryFileUploadController.class);
    ...
    @Autowired
     private InventoryProcessor  inventoryProcessor;
               ...
               @RequestMapping(value = WebConstantUrl.IMPORT_INVENTORY_FILE_UPLOAD ,method=RequestMethod.POST)
               public ResponseEntity<Map<String,Object>>testApi(@RequestParam("file") Part part) throws Exception
               {
                               ...
                               List<String> result = null;
                                               ...
                                               document.setName("Inventory = " + System.currentTimeMillis());
                                               document.setFileUploadType(FileUploadType.INVENTORY);
                                               ...
                                               result = inventoryProcessor.importInventoryRecords(inp);
