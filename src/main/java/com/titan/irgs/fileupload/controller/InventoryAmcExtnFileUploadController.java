...
import com.titan.irgs.fileupload.processor.InventoryAmcExtnProcessor;
import com.titan.irgs.fileupload.repository.UploadDocumentRepository;

@RestController
@RequestMapping(value=WebConstantUrl.INVENTORY_AMC_Extn_FILE_BASE_URL)
public class InventoryAmcExtnFileUploadController {
	
	
private static Logger logger = LoggerFactory.getLogger( InventoryAmcExtnFileUploadController.class);
    
    @Autowired
     private InventoryAmcExtnProcessor  inventoryAmcExtnProcessor;
               ...
               @RequestMapping(value = WebConstantUrl.IMPORT_INVENTORY_AMC_Extn_FILE_UPLOAD ,method=RequestMethod.POST)
               public ResponseEntity<Map<String,Object>>testApi(@RequestParam("file") Part part) throws Exception
               {
                               ...
                               List<String> result = null;
                                               ...
                                               result = inventoryAmcExtnProcessor.importInventoryAmcExtnRecords(inp);
