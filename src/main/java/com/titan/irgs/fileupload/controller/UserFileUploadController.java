...
import com.titan.irgs.fileupload.processor.UserProcessor;
import com.titan.irgs.fileupload.repository.UploadDocumentRepository;


@RestController
@RequestMapping(value = WebConstantUrl.USER_FILE_BASE_URL)

public class UserFileUploadController {
	
private static Logger logger = LoggerFactory.getLogger(StoreFileUploadController.class);
    ...
    @Autowired
     private UserProcessor  userProcessor;
               ...
               @RequestMapping(value = WebConstantUrl.IMPORT_USER_FILE_UPLOAD ,method=RequestMethod.POST)
               public ResponseEntity<Map<String,Object>> testApi(@RequestParam("file") Part part) throws Exception
               {
                               ...
                               List<String> result = null;
                                               ...
                                               document.setName("User = " + System.currentTimeMillis());
                                               document.setFileUploadType(FileUploadType.User);
...
//                                                                           ExcelSheetProcessor.class);
                                               ...
                                               result = userProcessor.importStoreRecords(inp);
