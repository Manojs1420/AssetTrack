...
import com.titan.irgs.fileupload.processor.InventoryAmcProcessor;
import com.titan.irgs.fileupload.repository.UploadDocumentRepository;

@RestController
@RequestMapping(value=WebConstantUrl.INVENTORY_AMC_FILE_BASE_URL)
public class InventoryAmcFileUploadController {
	
	
private static Logger logger = LoggerFactory.getLogger( InventoryAmcFileUploadController.class);
    
    @Autowired
     private InventoryAmcProcessor  inventoryAmcProcessor;
               ...
               @RequestMapping(value = WebConstantUrl.IMPORT_INVENTORY_AMC_FILE_UPLOAD ,method=RequestMethod.POST)
               public ResponseEntity<Map<String,Object>>testApi(@RequestParam("file") Part part) throws Exception
               {
                               ...
                               List<String> result = null;
                                               ...
                                               document.setFileUploadType(FileUploadType.INVENTORYAmc);
                                               ...
                                               result = inventoryAmcProcessor.importInventoryAmcRecords(inp);
