...
import com.titan.irgs.webRole.domain.WebRole;
	...
	@Entity
	@Table(name = "escalation1")
	@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "escalationId1", scope = Long.class)
	public class Escalation1 implements Serializable {
		...
		public Long getEscalationId1() {
			return escalationId1;
		}

		public void setEscalationId1(Long escalationId1) {
		...
		public void setSremailescalation1(Sremailescalation sremailescalation) {
			this.sremailescalation = sremailescalation;
		}
