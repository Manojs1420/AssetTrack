...
/**
 * This is VendorType domain class which map the vendor_type table
 * 
 * @author birendra
 *
 */
...
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "vendorTypeId", scope = Long.class)
