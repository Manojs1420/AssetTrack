...
import org.springframework.data.domain.Page;
	...
	public class Excellxporter1 {
	    ...
	    private List<?> classVariablesss;
	    
	    public Excellxporter1(){
	    	
	    }
	    public Excellxporter1(List<String> excelHeaders,List<?> classVar){
	    	this.headers=excelHeaders;
	    	this.classVariablesss=classVar;
	    	workbook = new XSSFWorkbook();

	    	
	    }
	  
	    public Excellxporter1(List<String> excelHeaders,Page<?> classVariables){
	    	this.headers=excelHeaders;
